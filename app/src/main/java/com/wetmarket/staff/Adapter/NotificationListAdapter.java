...
import com.wetmarket.staff.databinding.RowNotificationBinding;
...
public class NotificationListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
        ...
        public NotificationListAdapter(Context context, List<NotificationModel> items) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.row_notification, parent, false);
        ...
        protected class ViewHolderData extends RecyclerView.ViewHolder {
            ...
            public ViewHolderData(RowNotificationBinding binding) {
            ...
            public void bindData(final NotificationModel item, final int position) {
