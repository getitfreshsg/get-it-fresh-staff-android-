...
public class HomeFragment extends BaseFragment {
    ...
    public void initComponents(View rootView) {
        ...
        fragmentManager.beginTransaction().add(R.id.fameLayout,jobFragment,"1").commit();
        fragmentManager.beginTransaction().add(R.id.fameLayout, collectionFragment,"2").hide(collectionFragment).commit();
        fragmentManager.beginTransaction().add(R.id.fameLayout,orderFragment,"3").hide(orderFragment).commit();
    ...
    private void setTabText() {
        ...
        binding.fragmentMainTlHome.addTab(binding.fragmentMainTlHome.newTab().setIcon(tabIcons[0]).setText("To Be Purchased"));
        binding.fragmentMainTlHome.addTab(binding.fragmentMainTlHome.newTab().setIcon(tabIcons[1]).setText("At Colletion Center"));
        binding.fragmentMainTlHome.addTab(binding.fragmentMainTlHome.newTab().setIcon(tabIcons[2]).setText("Out For Delivery"));
